        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12 lg:gap-16">
          ...
          <div className="flex flex-col justify-center">
            <h1 className="text-4xl sm:text-5xl lg:text-[56px] font-extrabold tracking-tight text-[#111827] leading-[1.15]">
              Nutrição que <br />
              <span className="text-[#db2777]">trans</span>
              <span className="text-[#06b6d4]">forma</span> seu <br />
              dia
            </h1>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              ...
              <Button 
                size="lg" 
                className="bg-[#d946ef] hover:bg-[#c084fc] text-white rounded-xl px-6 py-6 font-medium shadow-sm transition-all flex items-center gap-2 text-sm"
              >
              ...
              <Button 
                variant="outline" 
                size="lg" 
                className="bg-white border border-gray-200 hover:bg-gray-50 text-[#111827] rounded-xl px-7 py-6 font-medium shadow-sm transition-all text-sm"
              >
                Saiba Mais
              </Button>
            </div>
